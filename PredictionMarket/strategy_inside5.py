...
class Strategy(BaseStrategy):
    """
    Inside-competitor v5: Optimized for all profitable regimes.
    - Always quote at (comp_bid+1, comp_ask-1)
    - Cooldown + fair_adj for risk control
    - Aggressive sizing (capture all retail)
    - Trade in spread_ticks >= 3 (comp_spread >= 5)
    - Universal cooldown_len=2 
    """
