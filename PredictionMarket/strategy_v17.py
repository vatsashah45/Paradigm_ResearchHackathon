...
class Strategy(BaseStrategy):
    """v17: base_size=10, simple with light inv protection and skew."""
    ...
    def on_step(self, state: StepState):
        ...
        # Inventory skew: shift quotes away from inventory side
        skew = net_inv * 0.12

        # Half-spread: base 2, widen with inventory and near end
        ...
        if steps_remaining > 50:
            ...
            if net_inv > -max_inv:
                avail = max(0.0, state.yes_inventory - size - (l2_size if steps_remaining > 20 else 0))
