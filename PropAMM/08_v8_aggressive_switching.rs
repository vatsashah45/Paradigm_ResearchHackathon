...
const P2_ARB_K: u128 = 20_000 * BPS;
const P2_COUNTER_K: u128 = 5_500 * BPS;
const P2_SIZE_K: u128 = 2_500 * BPS;
const P2_SHOCK_K: u128 = 1_400 * BPS;
const P2_DEFAULT_FEE: u128 = 28 * BPS;
const P2_TOX_READ_K: u128 = 5 * BPS;
...
const SWITCH_COOLDOWN: u64 = 2;
const SWITCH_ABS_GAP_UP: i64 = 20_000_000;
const SWITCH_ABS_GAP_DOWN: i64 = 150_000_000;
const SWITCH_REL_BPS: i64 = 100;
const ROUTE_BONUS_W: u128 = 145_000_000;
const SCORE_BIASES: [i64; NUM_PROFILES] = [0, -100_000_000, -170_000_000];
