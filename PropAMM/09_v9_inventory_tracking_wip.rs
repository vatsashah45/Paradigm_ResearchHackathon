...
const S_INV_IMBAL:  usize = 176; // i64: signed inventory imbalance (+ = long X, - = short X)
const S_INIT_RX:    usize = 184; // u64: initial reserve X
const S_INIT_RY:    usize = 192; // u64: initial reserve Y
